export default function FatherDaughterSilhouette() {
  return (
    <div className="relative h-full w-full">
      ...
      <svg
        viewBox="0 0 420 480"
        className="relative z-10 h-full w-full drop-shadow-[0_0_40px_rgba(255,120,60,0.35)]"
        aria-hidden="true"
      >
        <defs>
          ...
          <filter id="silhouetteGlow">
            <feDropShadow dx="0" dy="0" stdDeviation="8" floodColor="#ff8040" floodOpacity="0.45" />
          </filter>
        </defs>
